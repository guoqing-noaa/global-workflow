...
GPREFIX=${GPREFIX:-""}
GSUFFIX=${GSUFFIX:-".nc"}
SFCG01=${SFCG01:-${COMIN_ATMOS_HISTORY_PREV}/${GPREFIX}sfcf001${GSUFFIX}}
SFCG02=${SFCG02:-${COMIN_ATMOS_HISTORY_PREV}/${GPREFIX}sfcf002${GSUFFIX}}
...
SFCGES=${SFCGES:-${COMIN_ATMOS_HISTORY_PREV}/${GPREFIX}sfcf00${assim_freq}${GSUFFIX}}
...
ATMG01=${ATMG01:-${COMIN_ATMOS_HISTORY_PREV}/${GPREFIX}atmf001${GSUFFIX}}
ATMG02=${ATMG02:-${COMIN_ATMOS_HISTORY_PREV}/${GPREFIX}atmf002${GSUFFIX}}
...
ATMGES=${ATMGES:-${COMIN_ATMOS_HISTORY_PREV}/${GPREFIX}atmf00${assim_freq}${GSUFFIX}}
...
if [ ${DOHYBVAR} = "YES" ]; then
   SFCGES_ENSMEAN=${SFCGES_ENSMEAN:-${COMIN_ATMOS_HISTORY_ENS_PREV}/${GPREFIX_ENS}sfcf00${assim_freq}.ensmean.nc}
   export ATMGES_ENSMEAN=${ATMGES_ENSMEAN:-${COMIN_ATMOS_HISTORY_ENS_PREV}/${GPREFIX_ENS}atmf00${assim_freq}.ensmean.nc}
